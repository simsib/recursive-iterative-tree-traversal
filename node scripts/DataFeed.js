...
let node5 = new TreeNode(5,[new TreeNode("lorem",[]),new TreeNode("lorem",[]),new TreeNode("dolor",[]),new TreeNode("meow",[]),new TreeNode("whoop",[]),new TreeNode("ijasa",[])]);
...
let tree = new Tree("My Tree", [node1, node6]);
